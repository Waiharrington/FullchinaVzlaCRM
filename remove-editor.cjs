...
const editorIndex = cssContent.indexOf('/* --- Tablet Image Editor --- */');
if (editorIndex !== -1) {
  cssContent = cssContent.substring(0, editorIndex);
  fs.writeFileSync(cssFile, cssContent);
}

console.log('Done rewriting tsx and cleaning up css');
