...
export const allNavItems: NavItem[] = [
  ...
  { path: '/clientes', label: 'Clientes', icon: Users, roles: ['owner', 'manager'], group: 'Gestión' },
  { path: '/proveedores', label: 'Proveedores', icon: Building2, roles: ['owner', 'manager'], group: 'Gestión' },
  { path: '/inventario', label: 'Inventario', icon: Package, roles: ['owner', 'manager'], group: 'Gestión' },
  { path: '/almacen', label: 'Almacén', icon: Building2, roles: ['owner', 'manager'], group: 'Gestión' },
  { path: '/recetas', label: 'Recetas', icon: BookOpen, roles: ['owner', 'manager'], group: 'Gestión' },
  { path: '/produccion', label: 'Producción', icon: Beef, roles: ['owner', 'manager'], group: 'Gestión' },
